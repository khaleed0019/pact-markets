  ...
  return (
    <main className="mx-auto max-w-lg px-6 pb-24">
      ...
      <div className="mt-5 space-y-2">
        ...
        {PACT_REGISTRY_ADDRESS && error && <EmptyNotice title="Couldn't load the leaderboard" body={error.message} />}
        {PACT_REGISTRY_ADDRESS && !loading && !error && entries.length === 0 && (
        ...
        {entries.map((entry, i) => (
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              <p className="tabular truncate font-mono text-small text-chalk">{short(entry.author)}</p>
